...
public class CopyRight {
    ...
    public void setCopyRightObjectID(String copyRightObjectID) {
        CopyRightObjectID = copyRightObjectID;
    }
    ...
    public String getAuditionRecordsNum() {
        return AuditionRecordsNum;
    }

    public void setAuditionRecordsNum(String auditionRecordsNum) {
        AuditionRecordsNum = auditionRecordsNum;
    }
